...
export const forceLogout = createAction("app/forceLogout"); // "app/forceLogout" is the action type, it is not actually the directory or file path, it is just a string identifier for the action. More simpler words it is just a name.
